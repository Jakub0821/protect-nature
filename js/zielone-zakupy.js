document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadMoreInfo() {
        const moreInfo = [
            {
                imgSrc: 'images/organic-farming.jpg',
                alt: 'Ekologiczne rolnictwo',
                text: 'Ekologiczne rolnictwo wspiera zrównoważony rozwój.'
            },
            {
                imgSrc: 'images/local-market.jpg',
                alt: 'Lokalny rynek',
                text: 'Zakupy na lokalnym rynku wspierają lokalnych producentów.'
            }
        ];
