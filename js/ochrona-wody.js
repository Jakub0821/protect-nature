document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadMoreInfo() {
        const moreInfo = [
            {
                imgSrc: 'images/woda1.jpg',
                alt: 'Nowoczesne technologie',
                text: 'Nowoczesne technologie pomagają w oszczędzaniu wody.'
            },
            {
                imgSrc: 'images/woda2.jpg',
                alt: 'Oszczędzanie wody',
                text: 'Proste sposoby na oszczędzanie wody w domu.'
            }
        ];
